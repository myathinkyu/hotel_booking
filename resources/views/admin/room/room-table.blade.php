...
<!-- Mirrored from mannatthemes.com/dastone/default/apps-ecommerce-product-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 05:36:36 GMT -->
<head>
        <meta charset="utf-8" />
                            ...
                            <div class="table-responsive">
                                <table id="datatable" class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$room->persons}}</td>
                                        <td>
                                            <img src="{{ asset('assets/images/room_style/' . $room->image) }}" width="70px" height="40px"   alt="">
                                        </td>
                                        <td>{{$room->state}}</td>
                                     
                                        <td>                                                       
                                            <a href="{{ route('list.edit', $room->id) }}"><i class="las la-pen text-secondary font-16"></i></a>
                                            <a href="{{ route('list.delete', $room->id) }}"><i class="las la-trash-alt text-secondary font-16"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    </tbody>
...
<!-- Mirrored from mannatthemes.com/dastone/default/apps-ecommerce-product-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 05:36:37 GMT -->
</html>