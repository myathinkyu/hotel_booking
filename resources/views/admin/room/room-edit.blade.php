                            ...
                            <div class="card">
                                ...
                                <div class="card-body">                                    
                                    <div class="general-label">
                                        <form action="{{ route('list.update', $rooms->id) }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="type_id" name="type_id" >
                                                            @foreach($types as $type)
                                                                <option value="{{ $type->id }}" {{ $type->id == $rooms->type_id ? 'selected' : '' }}>
                                                                    {{ $type->name }} 
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" step="any" class="form-control" id="price" name="price" value="{{ $rooms->price }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" step="any" class="form-control" id="persons" name="persons" value="{{ $rooms->persons }}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="state" name="state" value="{{ $rooms->state }}">
                                                            <option>0</option>
                                                            <option>1</option>
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="description" name="description" rows="3">{{ $rooms->description }}</textarea>                             
                                            </div>

                                            <div class="form-group">
                                                <label for="file">File input</label>
                                                <input type="file" class="form-control-file bg-dark text-white" id="file" name="file">
                                                <img src="{{ asset('assets/images/room_style/' . $rooms->image) }}" width="70px" height="40px"   alt="">
