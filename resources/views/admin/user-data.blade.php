...
<!-- Mirrored from mannatthemes.com/dastone/default/tables-editable.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 05:37:07 GMT -->
<head>
        <meta charset="utf-8" />
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table  table-bordered table-sm" >
                                            ...
                                            <tbody>
                                                @foreach($user_data as $key=>$values)
                                                <tr>
                                                    <th>{{$values->id}}</th>
                                                    <td>{{$values->name}}</td>
                                                    <td>{{$values->email}}</td>
                                                    <td>{{ date('d-m-Y H:i A', strtotime($values->created_at)) }}</td>
                                                    <td>
                                                        <a href="{{ route('admin.edit', $values->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                                        <a href="{{ route('admin.delete', $values->id) }}" class="btn btn-danger btn-sm">Delete</a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                    ...
                                    <span class="float-right">
                                        ...
                                        <a href=" {{ route('admin.row') }}" class="btn btn-success btn-sm">Add New User</a>
                                    </span><!--end table-->     
                                </div><!--end card-body-->
                            </div><!--end card-->
                        </div> <!-- end col -->
...
<!-- Mirrored from mannatthemes.com/dastone/default/tables-editable.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 05:37:08 GMT -->
</html>