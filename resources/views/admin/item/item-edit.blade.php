                            ...
                            <div class="card">
                                ...
                                <div class="card-body">                                    
                                    <div class="general-label">
                                        <form action="{{ route('item.update', $food->id) }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step="any" class="form-control" id="price" name="price" value="{{ $food->price }}">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="category" name="category">
                                                        @foreach(['breakfast', 'lunch', 'dinner', 'drink'] as $category)
                                                            <option value="{{ $category }}" {{  $food->category == $category ? 'selected' : '' }}>
                                                                {{ ucfirst($category) }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <img src="{{ asset('assets/images/restaurants/' . $food->image) }}" width="70px" height="40px"   alt="">
