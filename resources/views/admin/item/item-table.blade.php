                            ...
                            <div class="table-responsive">
                                <table id="datatable" class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('assets/images/restaurants/' . $item->image) }}" width="70px" height="40px"   alt="">
                                        </td>
                                        <td>{{$item->category}}</td>
                                     
                                        <td>                                                       
                                            <a href="{{ route('item.edit', $item->id) }}"><i class="las la-pen text-secondary font-16"></i></a>
