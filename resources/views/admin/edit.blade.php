                                    ...
                                    <div class="general-label">
                                        <form action="{{ route('admin.update', $users->id) }}" method="post">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="horizontalInput2" name="name"  value="{{ $users->name }}">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="email" class="form-control" id="horizontalInput1" name="email" value="{{ $users->email }}" >
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="password" class="form-control" id="horizontalInput1" name="password" value="{{ $users->password }}" >
