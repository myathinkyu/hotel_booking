                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="row">
                                    <div class="col">
                                        <h4 class="page-title">About Table</h4>
                                        <ol class="breadcrumb">
                            ...
                            <div class="table-responsive">
                                <table id="datatable" class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('assets/images/about/' . $about->image) }}" width="70px" height="40px"   alt="">
                                        </td>
                                        <td>                                                       
                                            <a href="{{ route('about.edit', $about->id) }}"><i class="las la-pen text-secondary font-16"></i></a>
