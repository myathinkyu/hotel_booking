                            ...
                            <div class="card">
                                ...
                                <div class="card-body">                                    
                                    <div class="general-label">
                                        <form action="{{ route('about.update', $detail->id) }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <img src="{{ asset('assets/images/about/' . $detail->image) }}" width="70px" height="40px"   alt="">
