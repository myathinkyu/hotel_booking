<ul class="metismenu left-sidenav-menu">
                    ...
                    <li>
                        <a href="{{ route('admin.index') }}"> <i data-feather="home" class="align-self-center menu-icon"></i><span>Dashboard</span><span class="menu-arrow"></span></a>
                    ...
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            ...
                            <li class="nav-item"><a class="nav-link" href="{{ route('about.detail') }}"><i class="ti-control-record"></i>About</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('about.list') }}"><i class="ti-control-record"></i>About List </a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('about.table') }}"><i class="ti-control-record"></i>About List Table</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('item.create') }}"><i class="ti-control-record"></i>Restaurant</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('item.table') }}"><i class="ti-control-record"></i>Restaurant Table</a></li>
                            ...
                            <li>
                                <a href="javascript: void(0);"><i class="ti-control-record"></i>Reservation Management<span class="menu-arrow left-has-menu"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ route('reservation.table') }}">Reservation</a></li>                                    
                                                                 
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);"><i class="ti-control-record"></i>Hotel Configuration <span class="menu-arrow left-has-menu"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ route('room.type') }}">Room Types</a></li>                                    
                                    <li><a href="{{ route('room.show') }}">Room Types List</a></li>
                                    <li><a href="{{ route('room.style') }}">Rooms</a></li>
                                    <li><a href="{{ route('room.table') }}">Rooms List Table</a></li>
                                    <li><a href="{{ route('room.list') }}">Rooms List</a></li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li><a href="{{ route('admin.data') }}">User Datatable</a></li>
